  ...
  head: {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        ...
        name: 'description',
        content:
          '玫琳凱是您美麗的好朋友。我們相信，一支口紅的力量也能為世界帶來改變。我們提供優秀的產品和獨一無二的事業機會賦予女性擁有自主事業的權利，並鼓勵女性追求自我價值。MARY KAY 承諾將每一位顧客做為出發點，在產品質量和安全方面從不妥協，擁有200位科學家的研發團隊與1,500項產品專利，提供全方位美妝、護膚產品及營養補充品，創造專屬您的個人化完美肌膚體驗。',
      },
    ...
    script: [
      {
        hid: 'gtm',
        innerHTML: `var dataLayer = dataLayer || [];dataLayer.push({'site': {'market': 'TW','environment': 'PROD','language': 'zh-TW'}});`,
      },
      {
        hid: 'gtm',
