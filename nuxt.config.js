import productionLanguage from './i18n.config'
/**
  domain下如果有子資料夾，請在Path裡增加
  ex: https://host.com/yourPath   Path = '/yourPath/'

  productionLanguage:
  @param {string} lang - 'zh' or 'all'
  ex:  productionLanguage('all') 中英語言
...
export default {
  ...
  head: {
    title: '玫琳凱香港有限公司- Mary Kay (HK) Co. Ltd',
    meta: [
      { charset: 'utf-8' },
    ...
    script: [
      ...
      {
        hid: 'gtm',
        innerHTML: `var dataLayer = dataLayer || [];dataLayer.push({'site': {'market': 'HK','environment': 'PROD','language': 'zh-HK'}});`,
      },
    ],
