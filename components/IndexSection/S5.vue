<template>
  <div class="s5">
    <div class="banner">
      <img src="~assets/images/bg_ind_s4@2x.jpg" alt="" srcset="" />
    </div>
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-5 col-md-12 dark flex">
          <div class="body" data-aos="fade-left" data-aos-duration="1000">
            <p class="small_title">NEW</p>
            <h3 class="h4">CLINICAL SOLUTIONS</h3>
            <p class="margin-top_30">
              保養從溫和淨膚開始 隨時隨地輕輕一抹 卸妝清潔保濕都到位 溫柔卸淨 高效方便 保濕舒適
            </p>
